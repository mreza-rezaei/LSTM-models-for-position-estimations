...
y_data=mat['MSTrain'][:,63:64].astype('float32')
...
```
    ...
    <matplotlib.text.Text at 0x7f562f5f1f60>
...
```
    ...
    Epoch 1/1
    23209/23209 [==============================] - 80s - loss: 0.0205    





    <keras.callbacks.History at 0x7f55e84fecc0>
...
```
    ...
    Saved trained model at /home/reza/DL/BrainProject/yousefi/saved_models/M1UE2X.h5 
...
y_data=mat['MSTest'][:,63:64].astype('float32')
