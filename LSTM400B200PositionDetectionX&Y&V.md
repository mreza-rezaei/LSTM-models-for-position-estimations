...
```python
bins_before=200 #How many bins of neural data prior to the output are used for decoding
...
```
    ...
    Train data shape:  (23209, 201, 62)
    Train labels shape:  (23209, 4)
    Test data shape:  (4095, 201, 62)
...
```
    ...
    <matplotlib.text.Text at 0x7f80914038d0>
...
```python
path='saved_models/LSTM400P&VB200.h5'
model.load_weights(path)
```

### train the model for 100 iterations with batch_size 512

 model.fit(X_train,y_train,epochs=12,verbose=1,batch_size=128)
...
```
    ...
    Saved trained model at /home/reza/DL/BrainProject/yousefi/saved_models/LSTM400P&VB200.h5 
...
```
    ...
    RMSE Estmation X=7.276326
    RMSE Estmation Y=6.012424
    2D Distance=9.438970
...
```
    ...
    RMSE Estmation X=1.454255
    RMSE Estmation Y=1.954458
    2D Distance=2.436137
